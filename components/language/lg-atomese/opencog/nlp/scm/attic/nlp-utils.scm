;
; nlp-utils.scm OBSOLETE -- for reference purposes only.
;
;;; Commentary: OBSOLETE -- for reference purposes only.
;
...
"
	...
	; Purge, recursively, all of the word-instances in the parse.
